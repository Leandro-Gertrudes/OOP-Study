...
/*   Updated: 2026/01/12 16:04:12 by lgertrud         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap(const std::string& name) : ClapTrap(name) {
    ...
    energyPoints = 50;
    attackDamage = 20;
    std::cout << "ScavTrap constructor called for " << BOLD << name << UNBOLD << std::endl;
}
...
/* Destructor */
ScavTrap::~ScavTrap() {
    std::cout << "ScavTrap destructor called for " << BOLD << name << UNBOLD << std::endl;
}
